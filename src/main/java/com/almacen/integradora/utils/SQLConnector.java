...
/**
 * Punto central de acceso a Oracle mediante un pool de conexiones HikariCP.
 *
 * <p>Las credenciales se obtienen primero de variables de entorno y, como
 * alternativa para desarrollo, de {@code credentials.properties}. La Wallet
 * se resuelve desde el classpath para que el mismo artefacto WAR funcione en
 * desarrollo y despliegue.</p>
 *
 *
...
public class SQLConnector {
    ...
    static {
        try {
            ...
            config.setConnectionInitSql("ALTER SESSION SET TIME_ZONE = 'America/Mexico_City'");
    ...
    /**
     * Solicita una conexión administrada por el pool.
     *
     * @return conexión que el consumidor debe cerrar mediante try-with-resources
 ...
 */
    ...
    /** Libera el pool; debe invocarse únicamente al apagar la aplicación.
 *
 *
 * @author Daniel Jared Flores Beltrán
 * @since 2026-08-24
