...
/** Servicio de infraestructura para construir y enviar correos transaccionales del SGDA.
 *
 *
...
public class EmailSender {
     ...
     *
     * @param to valor de to requerido por la operación
     * @param subject valor de subject requerido por la operación
     * @param body valor de body requerido por la operación
 *
 *
 * @author Daniel Jared Flores Beltrán
 * @since 2026-08-24
